    ...
    CompositionLocalProvider(
        ...
        TextField(
            ...
            colors = TextFieldDefaults.colors(
                ...
                disabledContainerColor = if(transparentBackground) Color.Transparent else MaterialTheme.colorScheme.surfaceVariant,
                errorContainerColor = if(transparentBackground) Color.Transparent else MaterialTheme.colorScheme.surfaceVariant,
